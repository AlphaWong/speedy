...
func ConnectToRabbit(config *RabbitConfig, log *logrus.Entry) (<-chan amqp.Delivery, error) {
	...
	log.WithFields(logrus.Fields{
		"ex_name":        ed.Name,
		"ex_type":        ed.Type,
		"ex_auto_delete": *ed.AutoDelete,
		"ex_internal":    *ed.Internal,
		"ex_durable":     *ed.Durable,
		"q_name":         qd.Name,
		"q_auto_delete":  *qd.AutoDelete,
		"q_binding_key":  qd.BindingKey,
		"q_durable":      *qd.Durable,
		"q_exclusive":    *qd.Exclusive,
	}).Debugf("extracted configuration, going to bind")
	...
	log.WithFields(logrus.Fields{}).Debugf("Using delivery definition: %+v", dd)
